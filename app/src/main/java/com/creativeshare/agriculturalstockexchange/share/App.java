package com.creativeshare.agriculturalstockexchange.share;
...
public class App extends Application {
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(Language_Helper.updateResources(newBase, com.creativeshare.agriculturalstockexchange.preferences.Preferences.getInstance().getLanguage(newBase)));
    }
    @Override
